...
client.on('message', msg => {
	...
	// Help Command
		...
		// Generate base embed
		var helpMsg = generateEmbed("#1f1e21", ":question: Bowling Ball - Help", embedAuthor, embedLink, embedImg, "Here you can find my commands!", `Generated by ${author.username}#${author.discriminator}`, author.displayAvatarURL({ dynamic: true }));
	...
	// Set API Key Command
		...
		var aboutMsg = generateEmbed("#bc4f70", ":information_source: About Bowling Ball", embedAuthor, embedLink, embedImg, "Bowling Ball is a remake of VoopAI.", `Generated by ${author.username}#${author.discriminator}`, author.displayAvatarURL({ dynamic: true }));
		aboutMsg.addFields(
			{
				name: "What is VoopAI?",
